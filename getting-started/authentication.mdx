---
title: "mFoundry API Authentication: Bearer Tokens and Keys"
sidebarTitle: "Authentication"
description: "Authenticate every mFoundry API request with a Bearer token. Learn to generate, rotate, and revoke API keys and resolve common auth errors."
---
